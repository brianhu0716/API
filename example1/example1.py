...
def add():
    if request.method == 'POST': # open add.html then type parameters
    ...
    else: # http://127.0.0.1:5000/api/v1/resources/books/add?id=4&title=haha&first_sentence=aa&published=2000
